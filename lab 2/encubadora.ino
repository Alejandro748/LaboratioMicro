...
const int Resistencia = 13; // resistencia calentamiento
...
void Leds(){
    if(T<32.0){ 
	    digitalWrite(Roja, LOW); //se apaga luz roja
        digitalWrite(Azul, HIGH); //se enciende luz azul 
    }    
    else if(T>42.0){  
 	    digitalWrite(Azul, LOW); //se apaga luz azul
        digitalWrite(Roja, HIGH); //se enciende luz roja
	}
